      ...
      <LayoutOne>
        ...
        <div className="contact-area pt-100 pb-100">
          <div className="container">
            ...
            <img className="mb-80" style={{ height: "60vh", width: "100%", objectFit: "contain" }}
              src={
                process.env.PUBLIC_URL +
                "/assets/img/B2B/reliability.jpg"
              }
              alt=""
            />
